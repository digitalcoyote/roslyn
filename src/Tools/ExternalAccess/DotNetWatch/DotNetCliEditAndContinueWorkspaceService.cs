...
namespace Microsoft.CodeAnalysis.ExternalAccess.DotNetWatch
{
    ...
    internal sealed class DotNetWatchEditAndContinueWorkspaceService : IWorkspaceService
    {
        ...
        public void StartEditSession() => _workspaceService.StartEditSession();
        ...
        {
            var updates = await _workspaceService.EmitSolutionUpdate2Async(solution, cancellationToken).ConfigureAwait(false);
